...
public class DBRegister {
    ...
    public void storeUser (User u) {
        ...
        if (u != null) {
            ...
            store.put(DatabaseHelper.COL_BIRTH, u.getBirth());
            ...
            db.insert(DatabaseHelper.TABLE_USER, null, store);
        }
    ...
    public User getUser (String mail) {
        ...
        Cursor c = db.query(    DatabaseHelper.TABLE_USER,
                                new String[]{   DatabaseHelper.COL_PASSWORD, DatabaseHelper.COL_NAME, DatabaseHelper.COL_SURNAME,
                                                DatabaseHelper.COL_BIRTH, DatabaseHelper.COL_ADDRESS,
        ...
        if (c != null) {
            ...
            c.moveToFirst();
            User u = new User(mail, c.getString(0), c.getString(1), c.getString(2));
            u.setBirth(c.getString(3));
            u.setAddress(c.getString(4));
            u.setTel1(c.getString(5));
            u.setTel2(c.getString(6));
            u.setWebsite(c.getString(7));
            u.setPhoto(c.getString(8));
    ...
    public void updateProduit (User u) {
        open();
        ...
        updated.put(DatabaseHelper.COL_BIRTH, u.getBirth());
        ...
        db.update(DatabaseHelper.TABLE_USER, updated, DatabaseHelper.COL_MAIL + " = '" + u.getMail() + "'", null);
...
/*
    ...
    public void deleteUser (int id) {
        db.delete(DatabaseHelper.TABLE_USER, DatabaseHelper.COL_ID + "=?", new String[]{ id });
    }
